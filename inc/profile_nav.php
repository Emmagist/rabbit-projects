...
<nav class="navbar navbar-expand-lg navbar-light  bg-dark" id="profile-nav">
            ...
            <div class="collapse navbar-collapse profile-nav-div" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item pr-4 <?php if($first_part==""){echo "active";}else{echo "noactive";} ?>">
                  <a class="nav-link text-white" href="countless_task.php" id="profile-nav-a">Contactless Tasks & Delivery</a>
                </li>
                <li class="nav-item pr-4 <?php if($first_part==""){echo "active";}else{echo "noactive";} ?>">
